...
// ONE_REAL_SEND_MAX
// NO_AUTOMATIC_RETRY
const E2E_PROOF_MODE = 'TESTING_V3_CHECKOUT_PROOF';
...
console.log('E2E_PROOF_MODE=TESTING_V3_CHECKOUT_PROOF');
console.log('E2E_PROOF_ONE_REAL_SEND_MAX=YES');
